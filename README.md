...
A daily writer for sovereign AI infrastructure and Adaptive Inclusive Leadership Theory. Every morning a GitHub Action reads your research, writes one entry in your voice, commits it, Vercel publishes the blog, and the cut goes to LinkedIn and Facebook with the photograph.
...
- Blog only: set `"postToLinkedIn": false` and `"postToFacebook": false`.
